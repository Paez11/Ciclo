...
class MarcoRebote extends JFrame{
    ...
    public void comienza_el_juego () throws InterruptedException {
        ...
        pelotaConHilo p = new pelotaConHilo(pelota, lamina);
        new Thread(p).start();
    }
...
class pelotaConHilo implements Runnable{
    private Pelota pelota;
    private LaminaPelota lamina;

    public pelotaConHilo(Pelota pelota, LaminaPelota lamina) {
        this.pelota = pelota;
        this.lamina = lamina;
    }
    public void run(){
